...
while (fuelLevel <= 5000 || fuelLevel > 30000 || isNaN(fuelLevel)){
  ...
  if(fuelLevel <= 5000 || fuelLevel > 30000 || isNaN(fuelLevel)){
    console.log("Please enter a valid fuel level between 5000 and 30000.");
  }
...
numAstronauts = Number(input.question("Enter the number of Astronauts: "));
  if (numAstronauts <=0 || numAstronauts >7){
    console.log("Please enter a valid number number of Astronauts (maximum 7)")
